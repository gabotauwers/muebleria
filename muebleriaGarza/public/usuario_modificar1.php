...
<h2>Foto</h2><img id="fotoActual" src="data:image/png;base64,<?= $emplead['Foto']?>">
    ...
    <h2>Nombre</h2> <input name="NombreEmpleado" type="text" value="<?=$emplead['NombreEmpleado']?>" require>
        ...
        <h2>Contraseña</h2> <input name="Password" type="password" value="<?=$emplead['Password']?>" require>
        <div id="fotografia">
            <div id="cambia">
                <input id="fotoExistente" type="hidden" name="Foto" type="text" value="<?=$emplead['Foto']?>">
            </div>
        </div>
